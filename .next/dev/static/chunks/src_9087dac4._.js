...
function useLocalStorage(storageKey, defaultValue) {
    ...
    const getDefaultValue = ()=>{
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`1752383735_20_6_20_63_11`, "Failed to parse localStorage item", error));
            return defaultValue;
        }
    };
